...
const {Register, ChangePassword, ForgetPassword, Login, GetAllUserByRoomId, GetUserById, GetCustomerByEmail} = require('../controllers/UserController')
...
router.post('/user/getcustomerbyemail', authenticateToken, GetCustomerByEmail)
